...
const columns = [  
    ...
    { id: 'createduserid', label: 'Created By'},
    { id: 'createddate', label: 'Created Date'},        
    { id: 'modifieduserid', label: 'Modified By'},   
...
function createData(description, createduserid, createddate, modifieduserid, modifieddate) {
    return { description, createduserid, createddate, modifieduserid, modifieddate };
}  
