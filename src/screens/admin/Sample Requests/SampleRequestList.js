...
const columns = [
  ...
  { id: 'createdbyusername', label: 'Created By' },
  { id: 'status', label: 'Status' },
  { id: 'requesttoqcstatus', label: 'Request To QC Status' },
  { id: 'receivedqcstatus', label: 'Received By QC Status' },
];
